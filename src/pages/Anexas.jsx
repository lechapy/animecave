  ...
  return (
    <Box
      sx={{
        ...
        color: 'text.primary',
        minHeight: 'calc(100vh - 64px)', // Ajustado para ocupar el resto de la pantalla
        padding: '60px 20px',
        paddingBottom: '60px',
        ...
        alignItems: 'center',
        justifyContent: 'center', // Centrar contenido si es corto
      }}
    >
      <Typography
        variant="h1"
      ...
      <Box
        sx={{
          ...
          '& a': {
            color: 'secondary.main', // Color azul para enlaces
            textDecoration: 'none',
            '&:hover': {
      ...
      >
        ...
        <Typography variant="h6" component="h2" sx={{ color: 'primary.main', marginBottom: '15px' }}>
          Recursos de Anime
        </Typography>
        ...
        <Typography variant="body1" component="p" sx={{ marginBottom: '20px' }}>
          <Link href="https://anilist.co/" target="_blank" rel="noopener noreferrer">
            AniList
          </Link>
